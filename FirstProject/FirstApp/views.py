...
def display(req): #view function
	ss = '''<center>
              <h2 style='color:Blue;'>
                 Hello User,Welcome to Django FirstProject FirstApp
              </h2>
...
def homepage(request):
    htmldata='''<center>
        <h1>idi yadundira....!!!</h1>
        <hr />
        <h2>sadukomante ammailu ,aunty lu ani tirigite gittane ayyedi mari...</h2>
        <hr />
        <h3>url sakkaga kottara koti nakodakoo!!!</h3>
    </center>''';
    return HttpResponse(htmldata);
